...
ax1.hist(Y, bins=100, label='Relative Frequency from 150 samples', density=True)
ax1.set_xlabel('Intensity')
ax1.set_ylabel('Rel. Frequency')
ax1.grid(True)
#ax1.legend()

ax2.hist(Y_log, bins=100, label='Relative Frequency from 150 samples', density=True)
